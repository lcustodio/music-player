    ...
    albums: [
      {
        ...
        songs: [
          { id: "1", title: "Bloom", length: "5:15" },
          { id: "2", title: "Morning Mr Magpie", length: "4:41" },
          { id: "3", title: "Little by Little", length: "4:27" },
          { id: "4", title: "Feral", length: "3:13" },
          { id: "5", title: "Lotus Flower", length: "5:01" },
          { id: "6", title: "Codex", length: "4:47" },
          { id: "7", title: "Give Up the Ghost", length: "4:50" },
          { id: "8", title: "Separator", length: "5:20" }
        ],
        description:
      ...
      },
      {
        title: "OK Computer",
        songs: [
          { id: "9", title: "Airbag", length: "4:44" },
          { id: "10", title: "Paranoid Android", length: "6:23" },
          { id: "11", title: "Subterranean Homesick Alien", length: "4:27" },
          { id: "12", title: "Exit Music (For a Film)", length: "4:24" },
          { id: "13", title: "Let Down", length: "4:59" },
          { id: "14", title: "Karma Police", length: "4:21" },
          { id: "15", title: "Fitter Happier", length: "1:57" },
          { id: "16", title: "Electioneering", length: "3:50" },
          { id: "17", title: "Climbing Up the Walls", length: "4:45" },
          { id: "18", title: "No Surprises", length: "3:48" },
          { id: "19", title: "Lucky", length: "4:19" },
          { id: "20", title: "The Tourist", length: "5:24" }
        ],
        description:
    ...
    albums: [
      {
        title: "Dummy",
        songs: [
          { id: "21", title: "Mysterons", length: "5:02" },
          { id: "22", title: "Sour Times", length: "4:11" },
          { id: "23", title: "Strangers", length: "3:55" },
          { id: "24", title: "It Could Be Sweet", length: "4:16" },
          { id: "25", title: "Wandering Star", length: "4:51" },
          { id: "26", title: "It's a Fire", length: "3:49" },
          { id: "27", title: "Numb", length: "3:54" },
          { id: "28", title: "Roads", length: "5:02" },
          { id: "29", title: "Pedestal", length: "3:39" },
          { id: "30", title: "Biscuit", length: "5:01" },
          { id: "31", title: "Glory Box", length: "5:06" }
        ],
        description:
      ...
      },
      {
        title: "Third",
        songs: [
          { id: "32", title: "Silence", length: "4:58" },
          { id: "33", title: "Hunter", length: "3:57" },
          { id: "34", title: "Nylon Smile", length: "3:16" },
          { id: "35", title: "The Rip", length: "4:29" },
          { id: "36", title: "Plastic", length: "3:27" },
          { id: "37", title: "We Carry On", length: "6:27" },
          { id: "38", title: "Deep Water", length: "1:31" },
          { id: "39", title: "Machine Gun", length: "4:43" },
          { id: "40", title: "Small", length: "6:45" },
          { id: "41", title: "Magic Doors", length: "3:32" },
          { id: "42", title: "Threads", length: "5:45" }
        ],
        description:
